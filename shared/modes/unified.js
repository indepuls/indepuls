...
export const getComparateurStatuts    = (caBrutMensuel, prixAugmentes, mks, microSousType) => C.getComparateurStatuts(DATA, caBrutMensuel, prixAugmentes, mks, microSousType);
